...
namespace WebAQsede.Controllers
{
    public class EstabelecimentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CNPJ,Email,CEP,Cidade,Telefone,Endereco")] Estabelecimentos estabelecimentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CNPJ,Email,CEP,Cidade,Telefone,Endereco")] Estabelecimentos estabelecimentos)
        {
